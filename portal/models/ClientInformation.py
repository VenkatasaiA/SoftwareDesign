...
class ClientInformation(db.Model):
    __bind_key__ = 'db'
    Id = db.Column(db.Integer,Sequence('user_info_seq',start=1), unique=True, nullable=False, primary_key=True)
    ...
    address_1=db.Column(db.String(2000),nullable=False)
    address_2 = db.Column(db.String(2000))
